...
public class UtiliserDAO extends DAO<UtiliserMetier> {
    ...
    public UtiliserMetier create(UtiliserMetier obj) {
        try {
            ...
            if (result.first()) {
                ...
                prepare.setInt(4, obj.getIdentifiantVelo());
                prepare.setInt(5, obj.getNumero());
    ...
    public UtiliserMetier update(UtiliserMetier obj) {
        ...
        try {
            PreparedStatement prepare = bddConnecteur.prepareStatement(requete);
            prepare.setInt(1,obj.getIdentifiantVelo());
    ...
    public UtiliserMetier find(int id) {
        ...
        try {
            ...
            if(result.first()) {
                utiliser = new UtiliserMetier(id, result.getInt(COLONNE_UTILISER_FK_NUMERO), result.getInt(COLONNE_UTILISER_FK_IDENTIFIANTVELO), result.getTimestamp(COLONNE_UTILISER_DATERETRAIT), result.getTimestamp(COLONNE_UTILISER_DATEDEPOT));
            }
